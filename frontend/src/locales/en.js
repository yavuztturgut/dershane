export default {
  translation: {
    ...
    attendance: 'Attendance', student: 'Student', status: 'Status', total: 'Total', saveAttendance: 'Save attendance', attendanceSaved: 'Attendance saved.', noStudents: 'No active students were found in this class.', teacherAttendanceHint: 'Open one of your lessons in the schedule to take attendance.', notRecorded: 'Not recorded', attendanceTaken: 'Attendance taken', attendanceNotTaken: 'Attendance not taken', lessonCount: '{{count}} lessons', attendanceProgress: '{{taken}} / {{total}} attendance', markAllPresent: 'Mark all present', markPresentFor: 'Mark {{name}} present',
